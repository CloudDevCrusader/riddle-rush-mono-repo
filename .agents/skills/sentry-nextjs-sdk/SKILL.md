...
Propose: _"I recommend setting up Error Monitoring + Tracing + Session Replay. Want me to also add Logging or Profiling?"_
...
| _(client bundle)_ | `instrumentation-client.ts` (Next.js handles this directly) |
