...
**OTel tracing detected:** _"I see OpenTelemetry tracing in the project. I recommend Sentry's OTLP integration for tracing (via your existing OTel setup) + Error Monitoring + Sentry Logging [+ Metrics/Crons if applicable]. Shall I proceed?"_

**No OTel:** _"I recommend Error Monitoring + Tracing + Logging [+ Metrics if applicable]. Shall I proceed?"_
