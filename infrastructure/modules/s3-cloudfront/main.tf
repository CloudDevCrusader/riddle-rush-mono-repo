...
resource "aws_cloudfront_origin_access_control" "website" {
  ...
  description                       = "OAC for ${var.project_name} S3 bucket (${var.environment})"
...
resource "aws_cloudfront_distribution" "website" {
  enabled             = true
  comment             = "${var.project_name} PWA Distribution (${title(var.environment)})"
  ...
  ordered_cache_behavior {
    ...
    min_ttl     = 0
    default_ttl = var.data_files_ttl
    max_ttl     = 86400 # 1 day
  }
