...
echo ""
echo "Or manually:"
echo "  terraform import module.s3_website.aws_s3_bucket.website BUCKET_NAME"
echo "  terraform import module.cloudfront.aws_cloudfront_distribution.website DISTRIBUTION_ID"
