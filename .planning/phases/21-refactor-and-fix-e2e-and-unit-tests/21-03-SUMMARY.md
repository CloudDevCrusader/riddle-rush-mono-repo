...
dependency_graph:
  ...
  affects: [tests/e2e/credits.spec.ts, tests/e2e/language.spec.ts, tests/e2e/results.spec.ts, tests/e2e/offline.spec.ts]
tech_stack:
  added: []
...
**2. [Rule 1 - Naming consistency] Updated index.vue data-testid from menu-* to main-menu-***
- **Found during:** Task 5
