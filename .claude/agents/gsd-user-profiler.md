...
<reference>
@/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/user-profiling.md` to load:
