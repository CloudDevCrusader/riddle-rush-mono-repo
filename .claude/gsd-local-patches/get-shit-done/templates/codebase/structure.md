...
- Usage: Reference from command with `@/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
