...
Key references:
- @/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.md" "/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/markuswagner/projects/riddle-rush-mono-repo/.claude/get-shit-done/USER-PROFILE.md
```
