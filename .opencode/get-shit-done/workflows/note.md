...
- **Global scope**: `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/notes/`)
...
2. Glob `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/notes/` — works in any directory
