...
Use template from `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/markuswagner/projects/riddle-rush-mono-repo/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
