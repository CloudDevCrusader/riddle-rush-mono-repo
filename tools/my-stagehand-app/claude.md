...
const data = await stagehand.extract('extract the placeholder text on the name field', {
  page: page2,
})
```
...
```typescript
await page.deepLocator('/html/body/div[2]/div[3]/iframe/html/body/p').highlight({
  durationMs: 5000,
