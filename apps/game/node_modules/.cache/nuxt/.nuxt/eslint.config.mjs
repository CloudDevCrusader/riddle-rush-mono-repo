...
import { createConfigForNuxt, defineFlatConfigs, resolveOptions } from '../../../../../../node_modules/.pnpm/@nuxt+eslint-config@1.12.1_@typescript-eslint+utils@8.50.1_eslint@9.39.2_jiti@2.6.1__ty_f814d0a6b7e72e4b7f9e6599e9a61bee/node_modules/@nuxt/eslint-config/dist/flat.mjs';
...
export const options = resolveOptions({
  ...
  dirs: {
    pages: ["pages"],
    composables: ["composables", "utils", "stores", "composables"],
