 ...
 */
export async function waitForPageReady(page: Page, timeout: number = TIMEOUTS.MEDIUM): Promise<void> {
 ...
 */
export async function waitForSplashScreen(page: Page, timeout: number = TIMEOUTS.LONG): Promise<void> {
 ...
 */
export async function elementExists(locator: Locator, timeout: number = TIMEOUTS.SHORT): Promise<boolean> {
  try {
 ...
 */
export async function isVisible(locator: Locator, timeout: number = TIMEOUTS.SHORT): Promise<boolean> {
  try {
    await expect(locator).toBeVisible({ timeout })
    return true
  }
 ...
 */
export function getTestElement(
  page: Page,
  testId: string,
