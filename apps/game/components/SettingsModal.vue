      ...
      <div class="settings-card" @click.stop>
        ...
        <div class="settings-panel">
          ...
          <div class="control-item">
            <div class="control-icon-wrapper">
              <img
                :src="`${baseUrl}assets/settings/Validation.png`"
                alt="Validation"
                class="control-icon"
              />
            </div>
            <div class="control-content">
              <div class="control-label">Answer Validation</div>
              <div class="toggle-container">
                <button
                  class="toggle-btn"
                  :class="{ active: answerValidationEnabled }"
                  role="switch"
                  :aria-checked="answerValidationEnabled"
                  aria-label="Toggle answer validation"
