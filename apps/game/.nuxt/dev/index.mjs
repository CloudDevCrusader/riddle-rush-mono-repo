...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, setCookie, removeResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/@vue+shared@3.5.26/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withTrailingSlash, decodePath, withoutTrailingSlash } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/unstorage@1.17.3_@vercel+functions@3.3.4_@aws-sdk+credential-provider-web-identity@3.95_eac2840e0b1a635783c063c74fdd4068/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/unstorage@1.17.3_@vercel+functions@3.3.4_@aws-sdk+credential-provider-web-identity@3.95_eac2840e0b1a635783c063c74fdd4068/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/youch@4.1.0-beta.13/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/vue-router@4.6.4_vue@3.5.26_typescript@5.9.3_/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/devalue@5.6.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/vue@3.5.26_typescript@5.9.3/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/unhead@2.1.1/node_modules/unhead/dist/server.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/vue@3.5.26_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/node_modules/.pnpm/unhead@2.1.1/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/.data/kv"}));
...
const _DcQPoBtU3hxYmjJFjO4VpNQy1I84tHdQN455A_iIo = (function(nitro) {
...
const _TidfMmHpORvJD98pcJFMIG8T9ZZueIF1AwAESvCKUI = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/l58FTlGP") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const rootDir = "/home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game";
...
const _zUHAp2NUziJ96PH5uRi_JZRZlnASiFPHaxwVxJhT9xw = (nitroApp) => {
...
const plugins = [
  _DcQPoBtU3hxYmjJFjO4VpNQy1I84tHdQN455A_iIo,
_TidfMmHpORvJD98pcJFMIG8T9ZZueIF1AwAESvCKUI,
_zUHAp2NUziJ96PH5uRi_JZRZlnASiFPHaxwVxJhT9xw
];
...
const getClientManifest = () => import('file:///home/cloudcrusader/projects/riddle-rush-nuxt-pwa/apps/game/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _5YVkcp = _messagesHandler ;

const _lazy_KOoMbz = () => Promise.resolve().then(function () { return renderer$1; });
...
var app$1 = {
	title: "Riddle Rush",
	subtitle: "The ultimate guessing game for friends & family",
...
var home$1 = {
	offline_badge: "Play Offline",
	quick_start: "Quick Start",
	category_title: "Available Categories",
	category_description: "Categories are chosen randomly each round",
	load_more: "Load More Categories",
	about_link: "About the Game",
...
var features$1 = {
	...
	multiplayer: {
		title: "Multiplayer",
		description: "Perfect for game nights"
	},
	installable: {
		title: "Installable",
...
var game$1 = {
	...
	error_checking: "Error checking answer",
	other_answers: "Other solutions:",
	your_attempts: "Your attempts",
	category_loading: "Loading...",
	loading: "Loading...",
	all_submitted: "All players have submitted!",
	go_to_scoring: "Go to Scoring",
	new_round_started: "New round started!",
	error_starting: "Failed to start game. Please try again.",
	welcome: "Welcome! Guess a word from the category.",
	resumed: "Game resumed!",
	error_resuming: "Failed to load game. Starting fresh.",
	game_ended: "Game ended! Check your statistics.",
	error_ending: "Failed to save game results",
	multiplayer_setup: "Game started with {0} players!",
	error_multiplayer: "Failed to setup multiplayer game",
	next_round: "Next round started!",
	error_next_round: "Failed to start next round",
	enter_answer: "Please enter an answer",
	no_player: "No active player found",
	answer_submitted: "Answer submitted for {0}",
	answer_skipped: "{0} skipped their turn",
	correct_answer: "Correct!",
	incorrect_answer: "Wrong answer",
	no_active_session: "Please start a game first",
	error_submitting: "Failed to submit answer",
	wait_for_players: "Please wait for all players to submit"
};
var players$1 = {
	title: "Players",
	max_players: "Maximum {0} players allowed",
	added: "{0} added!",
	removed: "{0} removed",
	need_players: "Add at least one player to start",
	ready: "{0} players ready!",
	lets_start: "Let's start the show! 🎉",
	good_luck: "Good luck everyone! 🍀",
	may_the_best_win: "May the best win! 🏆",
	game_on: "Game on! 🎮",
	lets_play: "Let's play! 😃",
	showtime: "Showtime! ⭐",
	ready_set_go: "Ready, set, go! 🚀",
	error_start: "Failed to start game. Please try again.",
	name_required: "Please enter a player name",
	name_too_short: "Player name must be at least 1 character",
	name_too_long: "Player name must be 20 characters or less",
	duplicate_name: "A player with this name already exists",
	invalid_names: "Please fix invalid player names before starting",
...
var share$1 = {
	game_title: "Riddle Rush - The Ultimate Guessing Game",
	game_text: "Play Riddle Rush with me! An exciting word guessing game.",
	score_title: "My Riddle Rush Score",
	score_text: "I scored {score} points in Riddle Rush! 🎯",
	not_supported: "Sharing is not supported on this device",
	success: "Score shared successfully!",
	error: "Failed to share score"
};
var categories$1 = {
	female_name: "Female Name",
	male_name: "Male Name",
	water_vehicle: "Water Vehicle",
	flowers: "Flowers",
	plants: "Plants",
...
var leaderboard$1 = {
	title: "Leaderboard",
	empty: "No entries yet. Play some rounds!",
	clear: "Clear",
	score: "Score",
	category: "Category",
	time: "Time",
...
var settings$1 = {
	...
	leaderboard_disabled: "Leaderboard disabled",
