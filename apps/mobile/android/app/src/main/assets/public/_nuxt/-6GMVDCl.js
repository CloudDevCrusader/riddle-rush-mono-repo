import { _ as D } from './CauFRk1V.js'
import { _ as F } from './DcX8rSL6.js'
import { _ as R } from './CNQyzpOJ.js'
import { _ as z } from './DA8pLGgZ.js'
import { _ as L } from './DH_jaUQ-.js'
import { _ as V } from './ulm3v8Ys.js'
import { u as E } from './l4Qz3wUf.js'
import { u as H } from './DmZn1PRy.js'
import { u as P } from './DQggSIYX.js'
import {
  d as I,
  z as T,
  U as A,
...
import './KgXOTGdX.js'
const J = { class: 'leaderboard-page', 'data-testid': 'leaderboard-container' },
  M = { class: 'leaderboard-page__subtitle' },
  Q = ['enter', 'data-testid'],
  W = ['data-testid'],
  Y = { class: 'leaderboard-page__actions' },
  ee = I({
    __name: 'leaderboard',
    setup(ae) {
      const { t: e, toast: f } = E(),
        ...
        x = async () => {
          if (!_.value) {
            ...
            try {
              ...
              ;(Z().error('Error finishing game:', c),
              ...
              default: a(() => [
                d('div', J, [
                  ...
                  r(
                    ...
                    {
                      default: a(() => [d('h2', M, t(o(e)('leaderboard.ranking', 'Ranking')), 1)]),
                      _: 1,
                    }
                  ),
                  r(
  ...
  ue = q(ee, [['__scopeId', 'data-v-b517f0a8']])
