...
import { u as V } from './KgXOTGdX.js'
const A = { key: 0, class: 'global-loading-overlay' },
  ...
  j = ['src'],
  R = { class: 'loading-bar-track' },
  z = ['src'],
  H = { class: 'loading-percentage' },
  M = u({
  ...
  T = Object.assign(p(M, [['__scopeId', 'data-v-95284f49']]), { __name: 'GlobalLoading' }),
  W = { class: 'layout-container' },
  X = { key: 0, class: 'connection-indicator' },
  Y = ['src'],
