import { _ as A } from './CauFRk1V.js'
import { _ as F } from './DA8pLGgZ.js'
import { _ as I } from './DH_jaUQ-.js'
import { _ as W } from './DcX8rSL6.js'
...
import { u as ie } from './l4Qz3wUf.js'
import { u as ce } from './DmZn1PRy.js'
import { u as ue } from './DQggSIYX.js'
import './KgXOTGdX.js'
...
function ve(e, t = {}) {
  const { threshold: i = 50, onSwipe: a, onSwipeEnd: o, onSwipeStart: c, passive: p = !0 } = t,
    ...
    T = (s) => [s.touches[0].clientX, s.touches[0].clientY],
    M = (s, y) => {
      ;((d.x = s), (d.y = y))
    },
    u = (s, y) => {
...
const be = ['aria-label'],
  ...
  $e = ['enter'],
  Ne = ['for'],
  Te = ['id', 'onUpdate:modelValue', 'data-testid', 'placeholder'],
  Ge = q({
    __name: 'players',
    setup(e) {
      const { t, goBack: i, toast: a } = ie(),
        ...
        T = () => {
          ...
          const u = m.value.slice(0, r.value).map((x, G) => x.trim() || E(G))
          if (!u.length) {
            a.warning(t('players.need_players'))
            return
          }
                        ...
                        default: C(() => [
                          N(
                            ...
                            { color: 'gold' },
                            {
                              ...
                              default: C(() => [Y(' ' + $(l(t)('players.title')), 1)]),
                              _: 1,
                            }
                          ),
                          f('div', ge, [
                            ...
                            N(
                              ...
                              { default: C(() => [Y($(l(t)('players.start')), 1)]), _: 1 }
                            ),
                          ]),
                        ]),
                        _: 1,
  ...
  je = re(Ge, [['__scopeId', 'data-v-14f320fa']])
