          ...
          s(_)
            ? (a(),
              t('button', { key: 1, class: 'back-btn tap-highlight no-select', onClick: b }, [
                r('img', { src: s(d), alt: 'Back' }, null, 8, R),
              ]))
            : i('', !0),
          r('div', x, [y(e.$slots, 'default', {}, void 0, !0)]),
          r('div', N, [
            B ? (a(), t('div', S, 'v' + v(s(g)) + ' (' + v(s(u)) + ')', 1)) : i('', !0),
          ]),
        ])
      )
    },
  }),
  E = V($, [['__scopeId', 'data-v-cd900ec4']])
export { E as default }
