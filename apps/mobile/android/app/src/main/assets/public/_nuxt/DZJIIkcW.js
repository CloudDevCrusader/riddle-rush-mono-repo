import { _ as z } from './CauFRk1V.js'
import {
  d as D,
  L as M,
  A as E,
...
import { _ as O } from './DcX8rSL6.js'
import { _ as j } from './DH_jaUQ-.js'
import { _ as A } from './ulm3v8Ys.js'
import { u as Q } from './l4Qz3wUf.js'
const q = { class: 'game-slider' },
  J = { key: 0, class: 'game-slider__icon' },
  K = { class: 'game-slider__track' },
  W = ['value', 'min', 'max', 'aria-label'],
  Y = { key: 1, class: 'game-slider__label' },
  Z = D({
    __name: 'GameSlider',
    props: {
      modelValue: {},
        ...
        (e, t) => (
          ...
          $('div', q, [
            ...
            s(
              ...
              [
                s('div', K, [s('div', { class: 'game-slider__fill', style: I(c(k)) }, null, 4)]),
                s(
                  'div',
                  {
            ...
            i.label ? (E(), $('span', Y, p(i.label), 1)) : B('', !0),
          ])
        )
      )
    },
                ...
                s('div', te, [
                  f(
                    ...
                    { color: 'gold' },
                    {
                      ...
                      default: h(() => [X(' ' + p(c(r)('menu.options')), 1)]),
                      _: 1,
                    }
                  ),
                  f(
                  ...
                  f(
                    ...
                    { default: h(() => [X(p(c(r)('common.ok')), 1)]), _: 1 }
                  ),
                ]),
              ]),
              _: 1,
