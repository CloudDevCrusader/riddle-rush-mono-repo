const e = {
    description:
      'Ein spannendes Wortratespiel für Freunde und Familie. Offline spielbar, perfekt für Spieleabende!',
  ...
  t = {
    ...
    Weiblicher_Vorname: 'Weiblicher Vorname',
    Männlicher_Vorname: 'Männlicher Vorname',
    Wasserfahrzeug: 'Wasser Fahrzeug',
    Blumen: 'Blumen',
    Pflanzen: 'Pflanzen',
    Beruf: 'Beruf oder Gewerbe',
    Insekten: 'Insekt',
    Tier: 'Tier',
    Berg: 'Berg',
    Gewässer: 'Gewässer',
    deutsche_Städte: 'Deutsche Stadt',
    Ausländische_Stadt: 'Ausländische Stadt',
    Maschinen: 'Maschine',
    Technik: 'Technik',
    Raumfahrt: 'Raumfahrt',
    '*heit': 'Wort mit Endung -heit',
    '*ung': 'Wort mit Endung -ung',
    Farben: 'Farbe',
    Erfinder: 'Erfinder',
    Maler: 'Maler',
    Komponist: 'Komponist',
  ...
  r = {
    art: 'Art',
    description: 'Lernen Sie das Team hinter Riddle Rush kennen',
    game_design: 'Spieldesign',
    programming: 'Programmierung',
    title: 'CREDITS',
  },
  i = {
    installable: { description: 'Als App installieren', title: 'Installierbar' },
    multiplayer: { description: 'Perfekt für Spieleabende', title: 'Multiplayer' },
    offline: { description: 'Keine Internetverbindung nötig', title: 'Offline Spielen' },
  },
  a = {
  ...
  s = {
    ...
    error_loading: 'Fehler beim Laden der Spielsitzung',
    ...
    meta_description:
      'Ein aufregendes Wort-Ratespiel für Freunde und Familie. Offline spielbar, perfekt für Spielabende!',
    ...
    page_title: 'Riddle Rush - Spiel',
    pause: 'Spiel pausieren',
    players: 'Spieler',
    quitConfirmation: 'Bist du sicher, dass du das Spiel beenden möchtest?',
  ...
  o = {
    ...
    game: 'Spiel',
    letter: 'Buchstabe',
    no_games: 'Noch keine Spiele gespielt',
    rounds: 'Runden',
    score: 'Punkte',
    title: 'Spielverlauf',
  },
  ...
  d = {
    ...
    english: 'ENGLISH',
    german: 'DEUTSCH',
    select_prompt: 'Sprache auswählen',
    title: 'Sprachauswahl',
  },
  c = {
    ...
    description: 'Spielbestenliste',
    empty: 'Noch keine Einträge. Spiel ein paar Runden!',
    finish: 'Beenden',
    finish_error: 'Fehler beim Beenden',
    ...
    next_round: 'Nächste Runde spielen',
    no_players: 'Noch keine Spieler',
    points_this_round: 'Pkt diese Runde',
    ranking: 'Rangliste',
    score: 'Punkte',
    time: 'Zeit',
    title: 'Bestenliste',
  ...
  g = { warning: 'Sie sind offline. Einige Funktionen funktionieren möglicherweise nicht.' },
  m = {
    online: 'Online',
    connecting: 'Verbinde...',
  ...
  p = {
    reconnect_failed: 'Verbindung konnte nicht wiederhergestellt werden',
  ...
  f = {
    added: '{0} hinzugefügt!',
    count_label: 'Spielerzahl',
    decrease: 'Spieler entfernen',
    description: 'Wähle die Spieler und starte das Spiel',
  ...
  S = {
    ...
    player: 'Spieler',
    points: 'Pkt',
    post_round_prompt: 'Wie wollt ihr weitermachen?',
  ...
  R = {
    ...
    Weiblicher_Vorname: 'Female Name',
    Männlicher_Vorname: 'Male Name',
    ...
    deutsche_Städte: 'German City',
    Ausländische_Stadt: 'Foreign City',
    Maschinen: 'Machine',
    Technik: 'Technology',
    Raumfahrt: 'Space Travel',
    '*heit': 'Word ending in -heit',
    '*ung': 'Word ending in -ung',
    Farben: 'Color',
    Erfinder: 'Inventor',
    Maler: 'Painter',
    Komponist: 'Composer',
  ...
  P = {
    art: 'Art',
    description: 'Meet the team behind Riddle Rush',
    game_design: 'Game Design',
    programming: 'Programming',
    title: 'CREDITS',
  },
  F = {
    installable: { description: 'Install as an app', title: 'Installable' },
    multiplayer: { description: 'Perfect for game nights', title: 'Multiplayer' },
    offline: { description: 'No internet connection required', title: 'Play Offline' },
  },
  M = {
  ...
  B = {
    ...
    error_loading: 'Failed to load game session',
  ...
  x = {
    ...
    finish: 'Finish',
    finish_error: 'Error finishing game',
    ...
    points_this_round: 'pts this round',
    ranking: 'Ranking',
    score: 'Score',
    time: 'Time',
    title: 'Leaderboard',
  ...
  A = { warning: 'You are offline. Some features may not work.' },
  L = {
    online: 'Online',
  ...
  D = {
    added: '{0} added!',
    count_label: 'Players',
    decrease: 'Remove player',
    description: 'Choose players and begin your game',
  ...
  V = {
    ...
    player: 'Player',
    points: 'pts',
    post_round_prompt: 'What would you like to do next?',
  ...
  O = { legacy: !1, locale: 'de', fallbackLocale: 'en', messages: { en: K, de: k } }
export { O as default }
