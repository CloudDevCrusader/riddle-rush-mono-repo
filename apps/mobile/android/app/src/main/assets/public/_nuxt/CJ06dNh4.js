import { _ as me } from './CauFRk1V.js'
import {
  d as V,
  U as E,
  A as s,
...
import { _ as Re } from './DH_jaUQ-.js'
import { _ as Ne } from './CNQyzpOJ.js'
import { _ as Ge } from './CnCHzusH.js'
import { _ as Ie } from './ulm3v8Ys.js'
import { u as Le } from './l4Qz3wUf.js'
import { u as Be, b as Te } from './DQggSIYX.js'
import { u as De } from './DmZn1PRy.js'
import './KgXOTGdX.js'
const Pe = { class: 'game-player-card' },
              ...
              ? j(
                  ...
                  r(
                    'div',
                    {
                      ...
                      class: U(['game-player-card__indicator', e(l)]),
                    },
  ...
  Ue = { class: 'leaderboard-header' },
  We = { key: 0 },
  xe = { key: 1 },
  Oe = { class: 'leaderboard-content' },
  ...
  ht = V({
    ...
    setup(u) {
      ...
      const D = P(!1),
        ...
        oe = async () => {
          if (B.value) return
          if ($.value !== 'round-complete' || Z.value || D.value) {
            v.value = !0
            return
          }
          B.value = !0
