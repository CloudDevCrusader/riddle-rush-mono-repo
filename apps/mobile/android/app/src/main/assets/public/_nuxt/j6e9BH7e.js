import { _ as o, z as s, A as a, B as i, C as t, D as r } from './BRqkcXJS.js'
const u = {
    class:
  ...
  l = { class: 'max-w-520px text-center' },
  c = ['textContent'],
  d = ['textContent'],
  p = ['textContent'],
  f = {
    ...
    props: {
      ...
      statusText: { type: String, default: 'Internal server error' },
      description: { type: String, default: 'This page is temporarily unavailable.' },
      refresh: { type: String, default: 'Refresh this page' },
    },
    setup(e) {
      const n = e
      return (
        s({
          title: `${n.status} - ${n.statusText} | ${n.appName}`,
          script: [
            {
        ...
        (h, m) => (
          ...
          i('div', u, [
            t('div', l, [
              ...
              t(
                'h2',
                { class: 'font-semibold mb-2 sm:text-3xl text-2xl', textContent: r(e.statusText) },
                null,
                8,
                d
              ),
              t(
                'p',
                { class: 'mb-4 px-2 text-[#64748B] text-md', textContent: r(e.description) },
                null,
                8,
                p
              ),
  ...
  g = o(f, [['__scopeId', 'data-v-0b3fc84d']])
export { g as default }
