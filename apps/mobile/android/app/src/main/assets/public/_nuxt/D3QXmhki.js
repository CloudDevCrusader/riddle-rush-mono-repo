...
var Te = [
  ...
  ae = function (e, t) {
    return !(t.disabled || Ze(t) || et(t, e) || $e(t) || tt(t))
  },
  se = function (e, t) {
...
function U() {
  ...
  function l(N, I, Y, Z) {
    var K = I && I.prototype instanceof f ? I : f,
    ...
    return (
      P(
        ...
        (function (re, $, z) {
          ...
          function y(i, o) {
            for (S = i, F = o, e = 0; !D && B && !s && e < H.length; e++) {
              var s,
                c = H[e],
                b = k.p,
                p = c[2]
                  ...
                  if ((S || (i = 'next'), (e = C[i]))) {
                    ...
                    (S === 1 && (e = C.return) && e.call(C),
                      S < 2 &&
                        ...
                        (S = 1)))
                  C = r
                } else if ((e = (D = k.n < 0) ? F : re.call($, k)) !== a) break
              } catch (c) {
                ;((C = r), (S = 1), (F = c))
              } finally {
                B = 1
  ...
  mt = function (e, t) {
    var n = t?.document || document,
          ...
          if (v < 0)
            ...
            if (
              ...
              var E = g === 0 ? a.tabbableGroups.length - 1 : g - 1,
                R = a.tabbableGroups[E]
              p = x(o) >= 0 ? R.lastTabbableNode : R.lastDomTabbableNode
            } else W(s) || (p = m.nextTabbableNode(o, !1))
          } else {
            ...
            } else W(s) || (p = m.nextTabbableNode(o))
          }
      ...
      V = function (i) {
        ...
        if (s || o instanceof Document) s && (a.mostRecentlyFocusedNode = o)
          ...
          ;(b &&
            ...
            I(c || a.mostRecentlyFocusedNode || w()))
        }
      ...
      re = function (i) {
        ...
        a.recentNavEvent = i
        var s = Z({ event: i, isBackward: o })
        s && (W(i) && i.preventDefault(), I(s))
      },
      $ = function (i) {
      ...
      S = function () {
        ...
        return (
          ...
          n.addEventListener('keydown', $, { capture: !0, passive: !1 }),
      ...
      B = function () {
        if (a.active)
          return (
            ...
            n.removeEventListener('keydown', $, !0),
      ...
      D = typeof window < 'u' && 'MutationObserver' in window ? new MutationObserver(H) : void 0,
      k = function () {
        D &&
          (D.disconnect(),
          a.active &&
    ...
    return (
      (f = {
        ...
        deactivate: function (i) {
          ...
          var v = function () {
            we(function () {
              ;(p && I(Y(a.nodeFocusedBeforeActivation)), c?.())
            })
          }
          return p && b ? (b(Y(a.nodeFocusedBeforeActivation)).then(v, v), this) : (v(), this)
        },
        pause: function (i) {
