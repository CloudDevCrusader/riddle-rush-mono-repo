...
import {
  ...
  markdownSpace
} from "./chunk-JKHB76W6.js";
import "./chunk-BEP2ALIY.js";
import "./chunk-MLQ2GDC7.js";
import {
  visit
} from "./chunk-M7FB77HW.js";
import "./chunk-UMS4IAT3.js";
import "./chunk-G3PMV62Z.js";

// ../../node_modules/.pnpm/remark-mdc@3.10.0/node_modules/remark-mdc/dist/index.mjs
...
function extractOrdered(valueNode) {
  if (isMap(valueNode)) {
    ...
    for (const item of valueNode.items) {
      map2.push([item.key.value, extractOrdered(item.value)]);
    }
    return { type: "map", value: map2 };
  }
  if (isSeq(valueNode)) {
...
function buildFromOrdered(orderedNode) {
  if (orderedNode.type === "map") {
    ...
    for (const [key2, value] of orderedNode.value) {
      map2.items.push(new Pair(new Scalar(key2), buildFromOrdered(value)));
    }
    return map2;
  }
